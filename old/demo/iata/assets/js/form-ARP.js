    ...
    $('#test_form').validate({
        ...
        submitHandler: function(form) {                        
            if ($("#test_form").valid()) { //    form.submit();            
                ...
                //@test
                alert("Done!" +" Form: Completion Time=" + seconds +"s, " +"Consecutive Error Rate="+(errorSum)+ ", Finishing time="+endTime +"\n");
                window.location.href = "http://localhost:8080/bootstrap/docs/@start.php";
                
                //filepath="/Users/MDSaraG/Downloads/output.txt";                
                //filepath="Z:\MDSaraG On My Mac\Sites\bootstrap\output.txt"
                filepath="C:\\xampp\\htdocs\\output.txt";
