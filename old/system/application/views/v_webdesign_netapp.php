...
<div class="grid_4">
    ...
    <div class="projectIntro">
        ...
        <h6>My role :</h6>
        <p>
            I worked as UX/UI Designer (Intern). Conducted Design Research, designed and engineered in Customer Support, Search, Web Portal and Mobile sites, gauging design via Usability Testing, Web Analytics and Web Performance      </p>
