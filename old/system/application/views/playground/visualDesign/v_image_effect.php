...
<div class="grid_4">
  ...
  <p class="clearfix">
    <a href="<?php echo base_url(); ?>playground" class="green button float">&lt;&lt; Back to Playground</a>
  </p>
</div>
...
<div id="folio_scroller_container" class="grid_8 cleafix">
  <ul id="folio_scroller">
    <li><span>Polaroid effect 1</span><a href="#"><img alt="Polaroid effect 1" src="<?php echo base_url(); ?>images/playground/Polaroid_effect1.jpg" /></a></li>
    <li><span>Polaroid effect 2</span><a href="#"><img alt="Polaroid effect 2" src="<?php echo base_url(); ?>images/playground/Polaroid_effect2.jpg" /></a></li>
    <li><span>Polaroid effect 3</span><a href="#"><img alt="Polaroid effect 3" src="<?php echo base_url(); ?>images/playground/Polaroid_effect3.jpg" /></a></li>
