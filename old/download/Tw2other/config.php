...
define ( 'CONSUMER_KEY', 'JstkOkxRf7s0OF6l8CxLQ' );
define ( 'CONSUMER_SECRET', 'S6Mmq3rG2qclz9zU2oEkQ0Qkz3ZqSWgtawOqsoINoZQ' );

//填写tw2other的url，注意目录的大小写 。
define ( 'TW2OTHER_URL', 'http://www.yicaohci.com/download/Tw2other/');

//填写为你自己申请的SINA API KEY
//请注意,以前这里是SINA_APP_KEY，现在是SINA_API_KEY
define ( 'SINA_API_KEY', '3046284349' );
define ( 'SINA_API_SECRET', 'e1f0a26f31e881c0f0608e4b29703fef');
